...
|-----|---------|-------|------|------|-------------|------|
|  | Centroid | expected | 0..1 | SimplePoint_VersionStructure | Centre Coordinates of GROUP of STOP PLACEs. | Global or national location |
...
| ++ | pos | optional | 1..1 | gml:DirectPositionType |  | EPSG:2056 is LV95. We use it in the export. |

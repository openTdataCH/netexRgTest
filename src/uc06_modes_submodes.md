...
The [mapping tables](media/Mappingtabellen_NeTEx_v2.0.xls) contain both transforms as far as we use them. Only use sub modes that are approved in the mapping!
